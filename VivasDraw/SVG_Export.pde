...
private class SVG_Export {
  ...
  private boolean constructOffsetFloorJoint = false;  // When set to true offset floor joints will be created

  private boolean extrudeThroughSide = true;
  ...
  SVG_Export(int boxType) {
    ...
    constructOffsetFloorJoint = false;
    convertMeasurements();
    switch (boxType) {
    case BOX_OPEN_TOP:
      constructTop = false;
    ...
    case BOX_RAISED_FLOOR:
      ...
      constructCross[0] = false;
      if (floorOffset != 0) {
        constructOffsetFloorJoint = true;
      }
      break;
    default:
      constructTop = true;
  ...
  private void constructSVGPlan() {
    ...
    // Center piece
    boolean isCrossSection = false;
    plotSVGCenterPiece( constructCenter[0], isCrossSection, multipleJoints, BOUNDARY + (int) thicknessConvert, (int) ((boxHeightConvert * 2) + thicknessConvert) + (BOUNDARY * 3));
    // Cross section
    isCrossSection = true;
    plotSVGCenterPiece( constructCross[0], isCrossSection, multipleJoints, (BOUNDARY * 2) + (int) (thicknessConvert + boxLengthConvert), (int) ((boxHeightConvert * 2) + thicknessConvert) + (BOUNDARY * 3));
    svg.dispose();
    svg.endDraw();
  }
  ...
  private void plotSVGCenterPiece(boolean constructPiece, boolean isCrossSection, boolean multipleJoints, int xOffset, int yOffset) {
    if (constructPiece == true) {
      ...
      if (multipleJoints == false) {
        // Drawing side joints of center piece when multiple joints is set to false
        // Left
        ...
        // Creating center joint of the side joints
      ...
      // Don't construct bottom joint
        ...
        if (multipleJoints == false) {
          if ( constructCross[0] == true) {
            ...
            svg.line(xOffset + ((sidePieceLengthConvert + thicknessConvert ) / 2), yOffset + ((boxHeightConvert - (thicknessConvert * 2)) / 2), xOffset + ((sidePieceLengthConvert - thicknessConvert )/ 2), yOffset + ((boxHeightConvert - (thicknessConvert * 2)) / 2));
            svg.line(xOffset + ((sidePieceLengthConvert - thicknessConvert )/ 2), yOffset + ((boxHeightConvert - (thicknessConvert * 2)) / 2), xOffset + ((sidePieceLengthConvert - thicknessConvert )/ 2), yOffset + (endPieceCenterJointLengthConvert * 3));
            svg.line(xOffset + ((sidePieceLengthConvert - thicknessConvert )/ 2), yOffset + (endPieceCenterJointLengthConvert * 3), xOffset, yOffset + (endPieceCenterJointLengthConvert * 3));
          } else {
          ...
          if ((wasDrawingOutwards == true) && (disableExtendedJoint == false)) {
            if ( constructCross[0] == true) {
              svg.line(xOffset + (sidePieceJointLengthConvert * 3) + thicknessConvert, yOffset + (endPieceCenterJointLengthConvert * 3), xOffset + ((sidePieceLengthConvert + thicknessConvert )/ 2), yOffset + (endPieceCenterJointLengthConvert * 3));
              svg.line(xOffset + ((sidePieceLengthConvert + thicknessConvert )/ 2), yOffset + (endPieceCenterJointLengthConvert * 3), xOffset + ((sidePieceLengthConvert + thicknessConvert ) / 2), yOffset + ((boxHeightConvert - (thicknessConvert * 2)) / 2));
              svg.line(xOffset + ((sidePieceLengthConvert + thicknessConvert ) / 2), yOffset + ((boxHeightConvert - (thicknessConvert * 2)) / 2), xOffset + ((sidePieceLengthConvert - thicknessConvert )/ 2), yOffset + ((boxHeightConvert - (thicknessConvert * 2)) / 2));
              svg.line(xOffset + ((sidePieceLengthConvert - thicknessConvert )/ 2), yOffset + ((boxHeightConvert - (thicknessConvert * 2)) / 2), xOffset + ((sidePieceLengthConvert - thicknessConvert )/ 2), yOffset + (endPieceCenterJointLengthConvert * 3));
              svg.line(xOffset + ((sidePieceLengthConvert - thicknessConvert )/ 2), yOffset + (endPieceCenterJointLengthConvert * 3), xOffset - thicknessConvert, yOffset + (endPieceCenterJointLengthConvert * 3));
            } else {
  ...
  private void plotSVGTopPiece(boolean constructPiece, boolean isTopPiece, int xOffset, int yOffset) {
    ...
    if (constructPiece == true) {
      ...
      if ( constructCenter[0] == true) {
        ...
        if (( constructCross[0] == true) && (createCenterSlot == true)) {
          ...
          svg.line(xOffset + ((sidePieceLengthConvert + thicknessConvert) / 2), yOffset + (endPieceJointLengthConvert * 2), xOffset + ((sidePieceLengthConvert - thicknessConvert) / 2), yOffset + (endPieceJointLengthConvert * 2));
          svg.line(xOffset + ((sidePieceLengthConvert - thicknessConvert) / 2), yOffset + (endPieceJointLengthConvert * 2), xOffset + ((sidePieceLengthConvert - thicknessConvert) / 2), yOffset + endPieceJointLengthConvert);
        }
      }
    }
  }
  ...
  private void plotSVGEndPiece(int xOffset, int yOffset) {
    ...
    if (constructTop == false) {
      if (multipleJoints == false) {
        ...
        // Constructs center slot in end piece
        if ( constructCenter[0] == true) {
          ...
          // Constructs a straight line with no joints
          svg.line(xOffset, yOffset, xOffset + endPieceLengthConvert, yOffset);
        }
      }
    } else {
  ...
  private void plotSVGSidePiece(int xOffset, int yOffset) {
    ...
    if (constructTop == false) {
      ...
      svg.line(xOffset, yOffset, xOffset + sidePieceJointLengthC + thicknessC, yOffset);
      svg.line(xOffset + sidePieceJointLengthC + thicknessC, yOffset, xOffset + sidePieceJointLengthC + thicknessC, yOffset + thicknessC);
    ...
    // construct last joint of right side
